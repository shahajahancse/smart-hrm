...
{ id: "", class: "role-checkbox-modal",text: "<?php echo $this->lang->line('xin_acc_accounts');?>", check: "<?php if(isset($_GET['role_id'])) { if(in_array('71',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>", add_info: "",value: "71",  items: [
	...
	{ id: "", class: "role-checkbox-modal", text: "Employee  Issue",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "419", check: "<?php if(isset($_GET['role_id'])) { if(in_array('420',$role_resources_ids)): echo 'checked'; else: echo ''; endif; }?>"},
