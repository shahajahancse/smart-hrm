...
//$(document).ready(function(){
	...
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_view_company_emp_title');?>",  add_info: "<?php echo $this->lang->line('xin_view_company_emp_title');?>", value: "372",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_view_location_emp_title');?>",  add_info: "<?php echo $this->lang->line('xin_view_location_emp_title');?>", value: "373",}
	]},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_hrsale_custom_fields');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info');?>", value: "393",  items: [
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_enable');?>",  add_info: "<?php echo $this->lang->line('xin_role_enable');?>", value: "393",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "394",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_edit');?>", value: "395",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_delete');?>", value: "396",}
	]},	
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_set_employees_salary');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "351"},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_awards').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "232",},
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_transfers').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "233",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_resignations').'</small>';?>",  add_info: "<?php echo $this->lang->line('left_resignations');?>", value: "234",},
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_manager_level_title').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_manager_level_title');?>", value: "406"},
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_hrd_level_title').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_hrd_level_title');?>", value: "407"},
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_gm_om_level_title').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_gm_om_level_title');?>", value: "408"}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_travels').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "235",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_promotions').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "236",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_complaints').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "237",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_warnings').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "238",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_terminations').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "239",}
	]}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_designation').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "249",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_announcements').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "257",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('xin_assets').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "265"}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('xin_hr_events').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "272",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('xin_hr_meetings').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "276",}
	]},
	]},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('left_timesheet');?>",  add_info: "", value: "27",  items: [
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('left_attendance');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "28", items: [
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_enable');?>",  add_info: "<?php echo $this->lang->line('xin_role_enable');?>", value: "28",},
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_timesheet').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "397",},
	]},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_month_timesheet_title');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "10", items: [
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('xin_month_timesheet_title').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "253",},
	]},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_attendance_timecalendar');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info');?>", value: "261",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('left_date_wise_attendance');?>",  add_info: "<?php echo $this->lang->line('xin_view');?>", value: "29",items: [
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_enable');?>",  add_info: "<?php echo $this->lang->line('xin_role_enable');?>", value: "29",},
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_date_wise_attendance').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "381",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_upd_company_attendance').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "310",}
	]},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_overtime_request');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info');?>", value: "401", items: [
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_enable');?>",  add_info: "<?php echo $this->lang->line('xin_role_enable');?>", value: "401"},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "402"},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "403"},
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_office_shifts').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "311",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "288",},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_leaves').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "290",},
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_1st_level_approval').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "286",},
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_2nd_level_approval').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "312",}
	]},
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('left_generate_payslip');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info');?>", value: "36",items: [
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_enable');?>",  add_info: "<?php echo $this->lang->line('xin_role_enable');?>", value: "36",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "313",},
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_generate_company_payslips').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "314",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_payroll_verifier_title');?>",  add_info: "<?php echo $this->lang->line('xin_payroll_verifier_title');?>", value: "404"},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_payroll_approver_title');?>",  add_info: "<?php echo $this->lang->line('xin_payroll_approver_title');?>", value: "405"},
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_performance_indicator').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "301",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_performance_appraisal').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "305",}
	]},
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_tickets').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "309",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_projects').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "318",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_tasks').'</small>';?>", value: "322",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo '<small>'.$this->lang->line('xin_role_view').' '.$this->lang->line('left_training').'</small>';?>",  add_info: "<?php echo $this->lang->line('xin_role_view');?>", value: "344",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_acc_payment_gateway');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "118",},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_quote_manager');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "87",items: [
	...
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_add');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "412",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "413",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "414",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_view');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "420",},
	]},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_estimates');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_delete_role_info');?>", value: "415",items: [
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_enable');?>",  add_info: "<?php echo $this->lang->line('xin_role_enable');?>", value: "416",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_create');?>",  add_info: "<?php echo $this->lang->line('xin_role_create');?>", value: "417",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_edit');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "418",},
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_role_delete');?>",  add_info: "<?php echo $this->lang->line('xin_role_add');?>", value: "419",}
	]},
	...
	{ id: "", class: "role-checkbox", text: "<?php echo $this->lang->line('xin_acc_invoice_payments');?>",  add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info');?>", value: "330",},
	]},
