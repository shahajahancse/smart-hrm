        ...
        <div class="row">
          <div class="col-md-2">
            <div class="form-group">
              ...
              <input class="form-control d_month_year" id="d_month_year" value="<?php if(!isset($month_year)): echo date('Y-m'); else: echo $month_year; endif;?>" name="month_year" type="text">
            </div>
          </div>
