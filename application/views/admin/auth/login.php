...
<body class="hold-transition login-page" style="background-position: center center; background-size: cover; background-image: url('<?php echo base_url();?>skin/hrsale_assets/img/bg/bg-4.jpg');">
