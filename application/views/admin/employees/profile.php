  ...
  <div class="col-md-12">
    <div class="nav-tabs-custom mb-4">
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#xin_employee_set_salary"><?php echo $this->lang->line('xin_salary_title');?></a> </li>
        <?php //}?>
                        ...
                        <table class="table table-striped table-bordered dataTable" id="xin_table_shiftss" style="width:100%;">
                          ...
                          <?php
                          	if($system[0]->multi_shifts == '1'){
							  	$office_shift_ids = explode(',',$user[0]->office_shift_id);
								foreach($office_shift_ids as $multi_shift_id):
								$shift_info = $this->Employees_model->read_shift_information($multi_shift_id);
							?>
                            <tr>
                              <td><?php echo $shift_info[0]->shift_name;?></td>
                            </tr>
                            <?php
								endforeach;
							} else {
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active core-current-tab <?php echo $get_animate;?>" id="left_tickets" style="display:none;">
                     <div class="box <?php echo $get_animate;?>">
                      ...
                      <?php $ticket = $this->Tickets_model->get_employee_tickets($session['user_id']);?>
                      <div class="box-body">
                        <div class="box-datatable table-responsive">
                          <table class="datatables-demo table table-striped table-bordered xin_hrsale_table">
                            <thead>
