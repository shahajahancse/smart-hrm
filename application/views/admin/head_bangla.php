<div style="font-size:20px; font-weight:bold; text-align:center;margin-top:10px"><a style="text-decoration:none;" target="_blank"><?php echo xin_company_info(1)->company_name; ?></a></div>
