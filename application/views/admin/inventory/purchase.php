          ...
          <?php $attributes = array('id' => 'product-form', 'autocomplete' => 'off', 'class' => 'm-b-1 add');?>
            ...
            <?php echo form_open('admin/inventory/purchase', $attributes, $hidden);?>
                <table class="table table-bordered table-sm table-striped " id="appRowDiv">
                    ...
                    <!-- <tr> <input type="text" name="hidden_id" value="<?php echo  $col->id ?>"></tr> -->
                    <tr></tr>
                </table>
      ...
      <table class="datatables-demo table table-striped table-bordered" id="purchase_table" style="width:100%">
        <thead>
          <tr>
            ...
            <th class="text-center" style="width:120px;">Sub Category Name</th>
          ...
          <?php foreach ($products as $key => $rows) { ?>
            <tr>
              ...
              <?php if($user_role_id==1){?>
                ...
                <td class="text-center"><?php echo $rows->status==0?"
                    <span class='badge' style='background-color:#ffc107'><b>Pending</b></span>":
                    "<span class='badge' style='background-color:#28a745'><b>Accepted</b></span>";
                    ?></td>
              ...
              <td class="text-center">
                ...
                <?php } else{?>
                <a class="btn btn-sm btn-info" name="btn" href="<?= base_url('admin/inventory/purchase/'.$rows->id);?>">Edit</a>
                <?php }?>
              </td>
            </tr>
          <?php }} ?>
...
<script type="text/javascript">
   ...
   function addNewRow(){
      ...
      // items+= '<input type="text" name="hidden_id[]" value="<?php echo !empty($_GET['id'])? $_GET['id']:''; ?>">';
