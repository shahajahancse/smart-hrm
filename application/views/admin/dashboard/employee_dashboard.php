              ...
              <div class="stats-box-row" style="margin-top:40px">
               <div class="stats-box col-md-6">
                ...
                <div class="stats-box col-md-6">
                  <div class="text-center">
                   <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                      <path d="M17.1435 0.734131C7.69322 0.734131 0.0234375 8.40391 0.0234375 17.8542C0.0234375 27.3044 7.69322 34.9742 17.1435 34.9742C26.5938 34.9742 34.2635 27.3044 34.2635 17.8542C34.2635 8.40391 26.5938 0.734131 17.1435 0.734131ZM17.1435 31.5502C9.57642 31.5502 3.44745 25.4212 3.44745 17.8542C3.44745 14.687 4.52601 11.7766 6.34073 9.46535L25.5323 28.6569C23.2211 30.4717 20.3107 31.5502 17.1435 31.5502ZM27.9462 26.243L8.75466 7.05143C11.0659 5.2367 13.9763 4.15814 17.1435 4.15814C24.7105 4.15814 30.8395 10.2871 30.8395 17.8542C30.8395 21.0214 29.761 23.9318 27.9462 26.243Z" fill="#FF715B"/>
                   </svg>
                  </div>
  ...
  <div class="row equal-height-row " style="margin-top:-10px">
    ...
    <div class="col-sm-4 col_style">
      <div class="card">
        ...
        <div class="text-center">
          <a href="#"  style="margin-top:15px;color:#5442A8;">View All</a>  
        </div>
