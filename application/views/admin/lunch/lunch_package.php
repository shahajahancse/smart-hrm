    ...
    <div class="form-container">
        <form id="myForm" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="number" class="form-control common" name="office_give_percent" value="<?= $query[0]->office_givepercent ?>" id="office_give_percent">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Employee Percentage</label>
                <div class="col-md-8">
                    <input type="number" class="form-control common" name="stuf_give_percent" id="stuf_give_percent" value="<?= $query[0]->stuf_give_percent ?>" disabled>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Office TK</label>
                <div class="col-md-8">
                    <input type="number" class="form-control common" name="office_give_tk" id="office_give_tk" value="<?= $query[0]->office_give_tk ?>" disabled>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label">Employee TK</label>
                <div class="col-md-8">
                    <input type="number" class="form-control common" name="stuf_give_tk" id="stuf_give_tk" value="<?= $query[0]->stuf_give_tk ?>" disabled>
                </div>
            </div>
