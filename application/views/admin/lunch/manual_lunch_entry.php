            ...
            <tbody>
                ...
                <?php foreach ($results as $key => $raw) { ?>
                    ...
                    <tr>
                        ...
                        <td> <input type="number" class="form-control pay_meal" id="pm<?= $raw->user_id ?>" onchange="changeFun(<?= $raw->user_id ?>)" name="pay_meal[]" value="21"></td>
                        <td> <input type="number" class="form-control pay_amount" id="pa<?= $raw->user_id ?>" name="pay_amount[]" readonly value="<?=(21*45)?>"> </td>
                        <td> <input type="number" class="form-control cost_meal" id="cm<?= $raw->user_id ?>" onchange="changeCos(<?= $raw->user_id ?>)" name="cost_meal[]" ></td>
                        <td> <input type="number" class="form-control cost_amount" id="ca<?= $raw->user_id ?>" name="cost_amount[]" readonly></td>
                        <td> <input type="number" class="form-control balance" id="bl<?= $raw->user_id ?>" name="balance[]"  ></td>
