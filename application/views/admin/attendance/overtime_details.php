...
<body>
    ...
    <span style="width: 100%;display: block;text-align: center;margin-bottom: 7px;">Overtime Report Of
        <?= date('d M Y',strtotime($first_date)) ?> to <?= date('d M Y',strtotime($second_date)) ?> </span>
    <?php 
